...
function toUrlOrGoogle(query: string): string {
    const q = query.trim();
    if (!q) return '';
    try {
        const u = new URL(q);
...
const HistoryHero: React.FC<HistoryHeroProps> = ({ visits, savedUrlSet, onSaveClick }) => {
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <div className="mt-0.5 flex flex-wrap items-center gap-2 text-xs opacity-70">
                                                        ...
                                                        <span>•</span>
                                                        <span>{timeFormatter.format(visitDate)}</span>
                                                    </div>
                                                </div>
